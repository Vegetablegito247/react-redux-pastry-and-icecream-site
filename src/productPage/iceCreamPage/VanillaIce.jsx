...
function VanillaIce({ handleSideMenu }) {
    let vanillaProduct = useSelector((state) => state.vanillaIceCream.vanillaIceCreams);
    ...
    return (
        <div className='cheesePastry'>
            ...
            <div className="itemProducts">
                ...
                {!loading && vanillaProduct.map((items, index) => (
